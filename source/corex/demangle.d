...
private:
    ...
    */
    ...
    {
        debug(trace) printf("parseTypeModifiers front=%c\n", buffer.front);
    ...
    SymbolName:
        ...
        0                         // anonymous symbols
    */
    Result!void parseSymbolName()
    {
        debug(trace) printf("parseSymbolName front=%c\n", buffer.front);
    ...
    */
    ...
    {
        debug(trace) printf("parseLName front=%c\n", buffer.front);
    ...
    */
    Result!void parseTypeFunctionNoReturn()
    {
        debug(trace) printf("parseTypeFunctionNoReturn front=%c\n", buffer.front);
    ...
    */
    ...
    {
        debug(trace) printf("parseFuncAttrs front=%c\n", buffer.front);
    ...
    */
    ...
    {
        debug(trace) printf("parseParameters front=%c\n", buffer.front);
    ...
    Parameter2:
        ...
        L Type     // lazy
    */
    Result!void parseParameter2()
    {
        debug(trace) printf("parseParameters2 front=%c\n", buffer.front);
    ...
    */
    ...
    CallConvention:
        ...
        Y       // Objective-C
    */
    Result!void parseCallConvention()
    {
        debug(trace) printf("parseCallConvention front=%c\n", buffer.front);
    ...
    {
        debug(trace) printf("parseTemplateInstanceName front=%c\n", buffer.front);
    ...
    */
    ...
    {
        debug(trace) printf("parseTypeFunction front=%c\n", buffer.front);
